            ...
            <div className="col-md-6 grid-margin stretch-card">
              <div className="card tale-bg">
                <div className="card-people mt-auto">
                  ...
                  src={
                    appUrl + "public/AdminAssets/images/dashboard/people.svg"
                }
                  alt="people" />
                                ...
                                <div className="table-responsive mb-3 mb-md-0 mt-3">
                                  <table className="table table-borderless report-table">
                                    ...
                                    <tr>
                                      ...
                                      <td className="w-100 px-0">
                                        <div className="progress progress-md mx-4">
                                          <div className="progress-bar bg-warning" role="progressbar"   aria-valuenow="30" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                      </td>
                                    ...
                                    <tr>
                                      ...
                                      <td className="w-100 px-0">
                                        <div className="progress progress-md mx-4">
                                          <div className="progress-bar bg-danger" role="progressbar"   aria-valuenow="95" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                      </td>
                                    ...
                                    <tr>
                                      ...
                                      <td className="w-100 px-0">
                                        <div className="progress progress-md mx-4">
                                          <div className="progress-bar bg-info" role="progressbar"  aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                      </td>
                                    ...
                                    <tr>
                                      ...
                                      <td className="w-100 px-0">
                                        <div className="progress progress-md mx-4">
                                          <div className="progress-bar bg-primary" role="progressbar"    aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                      </td>
                    ...
                    <table className="table table-borderless">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><p className="mb-0"><span className="font-weight-bold me-2">65</span>(2.15%)</p></td>
                          <td className="text-muted">65</td>
                        </tr>
                        <tr>
                          <td className="ps-0">Ohio</td>
                          <td><p className="mb-0"><span className="font-weight-bold me-2">54</span>(3.25%)</p></td>
                          <td className="text-muted">51</td>
                        </tr>
                        <tr>
                          <td className="ps-0">Nevada</td>
                          <td><p className="mb-0"><span className="font-weight-bold me-2">22</span>(2.22%)</p></td>
                          <td className="text-muted">32</td>
                        </tr>
                        <tr>
                          <td className="ps-0">North Carolina</td>
                          <td><p className="mb-0"><span className="font-weight-bold me-2">46</span>(3.27%)</p></td>
                          <td className="text-muted">15</td>
                        </tr>
                        <tr>
                          <td className="ps-0">Montana</td>
                          <td><p className="mb-0"><span className="font-weight-bold me-2">17</span>(1.25%)</p></td>
                          <td className="text-muted">25</td>
                        </tr>
                        <tr>
                          <td className="ps-0">Nevada</td>
                          <td><p className="mb-0"><span className="font-weight-bold me-2">52</span>(3.11%)</p></td>
                          <td className="text-muted">71</td>
                        </tr>
                        <tr>
                          <td className="ps-0 pb-0">Louisiana</td>
                          <td className="pb-0"><p className="mb-0"><span className="font-weight-bold me-2">25</span>(1.32%)</p></td>
                    ...
                    <div className="card-body">
                      ...
                      <div className="charts-data">
                        <div className="mt-3">
                          ...
                          <div className="d-flex justify-content-between align-items-center">
                            <div className="progress progress-md flex-grow-1 me-4">
                              <div className="progress-bar bg-inf0" role="progressbar"    aria-valuenow="95" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        ...
                        <div className="mt-3">
                          ...
                          <div className="d-flex justify-content-between align-items-center">
                            <div className="progress progress-md flex-grow-1 me-4">
                              <div className="progress-bar bg-info" role="progressbar"   aria-valuenow="35" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        ...
                        <div className="mt-3">
                          ...
                          <div className="d-flex justify-content-between align-items-center">
                            <div className="progress progress-md flex-grow-1 me-4">
                              <div className="progress-bar bg-info" role="progressbar"    aria-valuenow="48" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
